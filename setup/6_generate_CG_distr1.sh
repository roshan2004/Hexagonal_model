...
echo 0 | gmx trjconv -f 3-run.trr -o 3-run.xtc -s 3-run.tpr
...
while [ $IDIH -lt $NDIHEDRALS ]; do
    echo $IDIH | gmx angle -type dihedral -f CG.xtc -n dihedrals.ndx -ov $DIR/dih_$IDIH.xvg -od $DIR/temp.xvg -xvg none &> $DIR/temp_dihedrals.txt
